...
export const LIKE_NOTE_SUCCESS = 'LIKE_NOTE_REQUEST';
export const LIKE_NOTE_FAIL = 'LIKE_NOTE_REQUEST';

export const NOTES_RATE_REQUEST = "NOTES_RATE_REQUEST";
export const NOTES_RATE_SUCCESS = "NOTES_RATE_SUCCESS";
export const NOTES_RATE_FAIL = "NOTES_RATE_FAIL";
